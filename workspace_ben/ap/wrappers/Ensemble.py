...
class Serializable(_object):
    ...
    def __init__(self):
        this = _Ensemble.new_Serializable()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Ensemble.delete_Serializable
    __del__ = lambda self: None
Serializable_swigregister = _Ensemble.Serializable_swigregister
...
class Distribution(Serializable):
    ...
    __repr__ = _swig_repr
    UniformAdd = _Ensemble.Distribution_UniformAdd
    UniformMult = _Ensemble.Distribution_UniformMult
    NormalAdd = _Ensemble.Distribution_NormalAdd
    NormalMult = _Ensemble.Distribution_NormalMult
    Undefined = _Ensemble.Distribution_Undefined

    def __init__(self):
        this = _Ensemble.new_Distribution()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Ensemble.delete_Distribution
    __del__ = lambda self: None

    def New(self):
        return _Ensemble.Distribution_New(self)

    def PDF(self, arg2):
        return _Ensemble.Distribution_PDF(self, arg2)

    def logPDF(self, arg2):
        return _Ensemble.Distribution_logPDF(self, arg2)

    def CDF(self, arg2):
        return _Ensemble.Distribution_CDF(self, arg2)

    def lower(self):
        return _Ensemble.Distribution_lower(self)

    def upper(self):
        return _Ensemble.Distribution_upper(self)

    def Mean(self):
        return _Ensemble.Distribution_Mean(self)

    def StdDev(self):
        return _Ensemble.Distribution_StdDev(self)

    def Moments(self, arg2):
        return _Ensemble.Distribution_Moments(self, arg2)

    def Sample(self):
        return _Ensemble.Distribution_Sample(self)

    def setWidth(self, x):
        return _Ensemble.Distribution_setWidth(self, x)

    def Type(self):
        return _Ensemble.Distribution_Type(self)

    def Dim(self):
        return _Ensemble.Distribution_Dim(self)
Distribution_swigregister = _Ensemble.Distribution_swigregister
...
class SampleDistribution(Distribution):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _Ensemble.delete_SampleDistribution
    __del__ = lambda self: None

    def CDF(self, arg2):
        return _Ensemble.SampleDistribution_CDF(self, arg2)

    def New(self):
        return _Ensemble.SampleDistribution_New(self)

    def AccumData(self, *args):
        return _Ensemble.SampleDistribution_AccumData(self, *args)

    def ComputeDistribution(self):
        return _Ensemble.SampleDistribution_ComputeDistribution(self)

    def numberData(self):
        return _Ensemble.SampleDistribution_numberData(self)

    def getValue(self, i):
        return _Ensemble.SampleDistribution_getValue(self, i)

    def getdim(self, i):
        return _Ensemble.SampleDistribution_getdim(self, i)

    def getRecordType(self):
        return _Ensemble.SampleDistribution_getRecordType(self)

    def getDataSetSize(self):
        return _Ensemble.SampleDistribution_getDataSetSize(self)
SampleDistribution_swigregister = _Ensemble.SampleDistribution_swigregister
...
class BinnedDistribution(SampleDistribution):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _Ensemble.delete_BinnedDistribution
    __del__ = lambda self: None

    def New(self):
        return _Ensemble.BinnedDistribution_New(self)

    def getLow(self, i):
        return _Ensemble.BinnedDistribution_getLow(self, i)

    def getHigh(self, i):
        return _Ensemble.BinnedDistribution_getHigh(self, i)

    def CDF(self, arg2):
        return _Ensemble.BinnedDistribution_CDF(self, arg2)
BinnedDistribution_swigregister = _Ensemble.BinnedDistribution_swigregister
...
class PointDistribution(SampleDistribution):
    ...
    def __init__(self, *args):
        this = _Ensemble.new_PointDistribution(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Ensemble.delete_PointDistribution
    __del__ = lambda self: None

    def New(self):
        return _Ensemble.PointDistribution_New(self)

    def getRecordType(self):
        return _Ensemble.PointDistribution_getRecordType(self)

    def AccumData(self, v, datapoint):
        return _Ensemble.PointDistribution_AccumData(self, v, datapoint)

    def getdim(self, i):
        return _Ensemble.PointDistribution_getdim(self, i)

    def numberData(self):
        return _Ensemble.PointDistribution_numberData(self)

    def getValue(self, i):
        return _Ensemble.PointDistribution_getValue(self, i)

    def Point(self):
        return _Ensemble.PointDistribution_Point(self)

    def CDF(self, v):
        return _Ensemble.PointDistribution_CDF(self, v)
PointDistribution_swigregister = _Ensemble.PointDistribution_swigregister
...
class NullDistribution(SampleDistribution):
    ...
    def __init__(self):
        this = _Ensemble.new_NullDistribution()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Ensemble.delete_NullDistribution
    __del__ = lambda self: None

    def New(self):
        return _Ensemble.NullDistribution_New(self)
NullDistribution_swigregister = _Ensemble.NullDistribution_swigregister
