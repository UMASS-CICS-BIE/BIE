...
class Serializable(_object):
    ...
    def __init__(self):
        this = _GaussTestLikelihoodFunctionRJ.new_Serializable()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _GaussTestLikelihoodFunctionRJ.delete_Serializable
    __del__ = lambda self: None
Serializable_swigregister = _GaussTestLikelihoodFunctionRJ.Serializable_swigregister
...
class Funct1d(_object):
    ...
    def G(self, arg2):
        return _GaussTestLikelihoodFunctionRJ.Funct1d_G(self, arg2)
    __swig_destroy__ = _GaussTestLikelihoodFunctionRJ.delete_Funct1d
    __del__ = lambda self: None
Funct1d_swigregister = _GaussTestLikelihoodFunctionRJ.Funct1d_swigregister
...
class LikelihoodFunction(Serializable):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["threshval"] = _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_threshval_set
    __swig_getmethods__["threshval"] = _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_threshval_get
    if _newclass:
        threshval = _swig_property(_GaussTestLikelihoodFunctionRJ.LikelihoodFunction_threshval_get, _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_threshval_set)

    def CumuProb(self, z, sd, norm, t, s, indx, f):
        return _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_CumuProb(self, z, sd, norm, t, s, indx, f)

    def LikeProb(self, *args):
        return _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_LikeProb(self, *args)

    def ParameterDescription(self, i):
        return _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_ParameterDescription(self, i)
    __swig_destroy__ = _GaussTestLikelihoodFunctionRJ.delete_LikelihoodFunction
    __del__ = lambda self: None
LikelihoodFunction_swigregister = _GaussTestLikelihoodFunctionRJ.LikelihoodFunction_swigregister
LikelihoodFunction_swigregister(LikelihoodFunction)
cvar = _GaussTestLikelihoodFunctionRJ.cvar

class GaussTestLikelihoodFunctionRJ(LikelihoodFunction):
    __swig_setmethods__ = {}
