...
class LikelihoodComputation(_object):
    ...
    def __init__(self):
        this = _Likelihood.new_LikelihoodComputation()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _Likelihood.delete_LikelihoodComputation
    __del__ = lambda self: None

    def Likelihood(self, state, indx):
        return _Likelihood.LikelihoodComputation_Likelihood(self, state, indx)
LikelihoodComputation_swigregister = _Likelihood.LikelihoodComputation_swigregister
